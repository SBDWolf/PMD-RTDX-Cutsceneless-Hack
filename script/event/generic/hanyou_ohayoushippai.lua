...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("PEGID_HANYOU_OHAYOUSHIPPAI__8480","★NEW★",[[ -- Good morning, [hero].
      おはよう　[hero]。]]),
    TextID("PEGID_HANYOU_OHAYOUSHIPPAI__6567","★NEW★",[[ -- We blew it yesterday, so let's get it right[R]this time.
      {昨日|きのう}は　うまくいかなかったけど
      {今度|こんど}は　がんばろうぜ。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("PEGID_HANYOU_OHAYOUSHIPPAI__9349","★NEW★",[[ -- Good morning, [hero].
      おはよう　[hero]。]]),
    TextID("PEGID_HANYOU_OHAYOUSHIPPAI__6486","★NEW★",[[ -- We failed yesterday, so let's try harder[R]this time.
      {昨日|きのう}は　うまくいかなかったけど
      {今度|こんど}は　がんばろうね。]]),
  },
  -- -----------------------------------------
