...
# x
  CH:HERO:{
    ...
    7::DirTo:{"isWait":true,"rotType":0,"speedDeg":250.0,"speedDegSymbol":"","withWalkMotion":true,"targetRot":{"rotType":300,"onlyYaw":true,"rotQ":{"x":0.0,"y":0.896728515625,"z":0.0,"w":0.4425811469554901},"lookSymbol":"PARTNER"}}
  }
  CH:PARTNER:{
    ...
    8::DirTo:{"isWait":true,"rotType":0,"speedDeg":300.0,"speedDegSymbol":"","withWalkMotion":true,"targetRot":{"rotType":300,"onlyYaw":true,"rotQ":{"x":0.0,"y":-0.4425811469554901,"z":0.0,"w":0.896728515625},"lookSymbol":"HERO"}}
    9::Sleep:{"timeSec":0.5}
  }
}
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D08P01_DEAD_01_0010","★NONE★",[[ -- Urrrgh...[K][R]We couldn't get through...
      ううっ……[K]
      {突破|とっぱ}できなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D08P01_DEAD_01_0020","★NONE★",[[ -- Ouch...[K][R]We couldn't break through...
      ううっ……[K]
      {突破|とっぱ}できなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D08P01_DEAD_01_0030","★NONE★",[[ -- We have to get through this[R]fast, or they'll catch up to us.
      {早|はや}く　ここをぬけないと
      {追|お}ってくるポケモンたちに　つかまっちゃうよ。]]),
    TextID("D08P01_DEAD_01_0040","★NONE★",[[ -- [hero], let's give it our best!
      [hero]　がんばろうぜ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D08P01_DEAD_01_0050","★NONE★",[[ -- If we don't get through here fast,[R]they'll catch up to us.
      {早|はや}く　ここをぬけないと
      {追|お}ってくるポケモンたちに　つかまっちゃう。]]),
    TextID("D08P01_DEAD_01_0060","★NONE★",[[ -- [hero], let's do our best!
      [hero]　がんばろうね！]]),
  },
  -- -----------------------------------------
})
