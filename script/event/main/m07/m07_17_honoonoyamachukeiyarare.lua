...
-- <<★ActAssetBlob
ASSET:ActAsset_Map:d09_02_honoo_md:{"symbolName":"d09_02_honoo_md"}
ASSET:ActAsset_CameraParam:CAM_00:{"symbolName":"CAM_00","param":{"fovType":0,"fieldOfView":23.0,"near":0.10000000149011612,"far":1000.0,"rotateType":100,"pos":{"x":-14.557730674743653,"y":4.15316915512085,"z":21.181476593017579},"rotateQ":{"x":0.0003359918773639947,"y":0.9745920896530151,"z":-0.22398187220096589,"w":0.0014619730645790697},"rotateAtPos":{"x":0.0,"y":0.0,"z":1.0},"rotateAtRollDeg":0.0}}
...
Parallel:{
  CAMERA::{
    ...
    1::SetCam:{"cameraParam":{"refSymbol":"","directData":{"fovType":105,"fieldOfView":23.0,"near":0.10000000149011612,"far":1000.0,"rotateType":100,"pos":{"x":-14.554234504699707,"y":3.8200063705444338,"z":20.361906051635743},"rotateQ":{"x":-1.0132165328968768e-8,"y":0.9727641940116882,"z":-0.23179705440998078,"w":-4.252087393297188e-8},"rotateAtPos":{"x":0.0,"y":0.0,"z":1.0},"rotateAtRollDeg":0.0}}}
  }
  CH:HERO:{
...
Parallel:{
  ...
  *::{
    0::PlayBgm:{"symbol":"BGM_DUN_HONOO_02","fadeInTime":0.0,"isLoop":true,"channel":0,"volume":1.0,"volumeSymbol":"DEFAULT"}
  }
}
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D09P02_M01E07B_4_01_0010","★NONE★",[[ -- Hmmm...[K][R]Well, that didn't go well.
      うーん……[K]
      うまくいかなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D09P02_M01E07B_4_01_0020","★NONE★",[[ -- Hmmm...[K][R]That didn't work out...
      うーん……[K]
      うまくいかなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D09P02_M01E07B_4_01_0030","★NONE★",[[ -- But we almost made it.[K][R]Let's give it our best again!
      でも　あともう{少|すこ}しだ。[K]
      がんばろうな！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D09P02_M01E07B_4_01_0040","★NONE★",[[ -- But we came close.[K][R]Let's keep doing our best!
      でもあと　もうちょっとだよ。[K]
      がんばろうね！]]),
  },
  -- -----------------------------------------
