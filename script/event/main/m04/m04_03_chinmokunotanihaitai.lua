...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E04A_4_01_0010","★CHANGE★",[[ -- Morning![K][R]Let's save [kind_p:WATAKKO] for sure today!
      おはよう！[K]
      {今日|きょう}こそ　[act_name:WATAKKO]を{助|たす}けようぜ！]]),
    TextID("PEGID_M04_03_CHINMOKUNOTANIHAITAI__1043","★NEW★",[[ -- [hero], let's roll![R]Off we go to the [dungeon:D005]!
      {行|い}こうぜ！　[hero]！
      [dun:D005]へ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E04A_4_01_0020","★CHANGE★",[[ -- Good morning![K][R]Let's be sure to rescue [kind_p:WATAKKO] today!
      おはよう！[K]
      {今日|きょう}こそ　[act_name:WATAKKO]を{助|たす}けようね！]]),
    TextID("PEGID_M04_03_CHINMOKUNOTANIHAITAI__6549","★NEW★",[[ -- Let's go, [hero]![R]To the [dungeon:D005] we go!
      {行|い}こう！　[hero]！
      [dun:D005]へ！]]),
