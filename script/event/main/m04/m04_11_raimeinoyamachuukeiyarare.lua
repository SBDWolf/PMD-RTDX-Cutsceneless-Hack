...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D06P02_M01E04B_6_01_0010","★NONE★",[[ -- Hmmm...[K][R]Things didn't go right for us...
      うーん……[K]
      うまくいかなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D06P02_M01E04B_6_01_0020","★NONE★",[[ -- Hmmm...[K][R]Things didn't turn out in our favor...
      うーん……[K]
      うまくいかなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D06P02_M01E04B_6_01_0030","★CHANGE★",[[ -- But we should be getting close.[K][R]Let's keep going hard at it!
      でも　あともう{少|すこ}しだ。[K]
      がんばろうぜ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D06P02_M01E04B_6_01_0040","★NONE★",[[ -- But we shouldn't be far.[K][R]Let's keep doing our best!
      でも　あともうちょっとだよ。[K]
      がんばろうね！]]),
  },
  -- -----------------------------------------
