...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E05A_4_01_0010","★NONE★",[[ -- Morning, [hero]!
      おはよう！　[hero]！]]),
    TextID("B01P01A_M01E05A_4_01_0020","★CHANGE★",[[ -- Let's head to the [dungeon:D007][R]for sure and find [kind_p:NEITYIO] today!
      {今日|きょう}こそは　[dun:D007]に{行|い}って
      [act_name:NEITYIO]に{会|あ}おうぜ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E05A_4_01_0030","★NONE★",[[ -- Good morning, [hero]!
      おはよう！　[hero]！]]),
    TextID("B01P01A_M01E05A_4_01_0040","★CHANGE★",[[ -- Let's make sure to go to the [dungeon:D007][R]and see [kind_p:NEITYIO] today!
      {今日|きょう}こそは　[dun:D007]に{行|い}って
      [act_name:NEITYIO]に{会|あ}おうね！]]),
  },
  -- -----------------------------------------
})
-- x
