...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D10P01_M01E08A_3_01_0010","★NONE★",[[ -- Urrrgh...[K][R]We couldn't get through...
      うぐぅ……
      {突破|とっぱ}できなかったな。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D10P01_M01E08A_3_01_0020","★NONE★",[[ -- Ouch...[K][R]We couldn't break through...
      うぐぅ……
      {突破|とっぱ}できなかったね。]]),
  },
  -- -----------------------------------------
...
-- <<★ActCommandBlob
CH:PARTNER:{
  0::SetFace:{"faceType":1,"eyeType":5,"mouthType":3}
}
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D10P01_M01E08A_3_01_0030","★NONE★",[[ -- This is a tough place...
      やっぱり　きびしいところだけど…]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D10P01_M01E08A_3_01_0040","★NONE★",[[ -- This is as tough as we expected...
      やっぱり　きびしいところだけど…]]),
  },
  -- -----------------------------------------
})
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D10P01_M01E08A_3_01_0050","★NONE★",[[ -- But let's give it our best[R]and get through this, [hero]!
      でも　がんばって{越|こ}えようぜ。
      [hero]！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D10P01_M01E08A_3_01_0060","★NONE★",[[ -- But let's keep trying our best[R]and get through this, [hero]!
      でも　がんばって{越|こ}えようね。
      [hero]！]]),
  },
  -- -----------------------------------------
