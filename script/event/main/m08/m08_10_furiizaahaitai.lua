...
ASSET:ActAsset_CameraParam:CAM_00:{"symbolName":"CAM_00","param":{"fovType":0,"fieldOfView":23.0,"near":0.10000000149011612,"far":1000.0,"rotateType":100,"pos":{"x":-14.518871307373047,"y":4.087817192077637,"z":21.160402297973634},"rotateQ":{"x":0.0003359918773639947,"y":0.9745920896530151,"z":-0.22398187220096589,"w":0.0014619730645790697},"rotateAtPos":{"x":0.0,"y":0.0,"z":1.0},"rotateAtRollDeg":0.0}}
ASSET:ActAsset_Chara:HERO:{"symbolName":"HERO","pos":{"posType":0,"pos":{"x":-15.037096977233887,"y":0.0,"z":13.690741539001465},"symbol":""},"rot":{"rotType":0,"onlyYaw":true,"rotQ":{"x":0.0,"y":0.9238795638084412,"z":0.0,"w":-0.38268327713012698},"lookSymbol":""}}
ASSET:ActAsset_Chara:PARTNER:{"symbolName":"PARTNER","pos":{"posType":0,"pos":{"x":-13.901573181152344,"y":0.0,"z":12.820599555969239},"symbol":""},"rot":{"rotType":0,"onlyYaw":true,"rotQ":{"x":0.0,"y":0.7147058844566345,"z":0.0,"w":-0.6994251012802124},"lookSymbol":""}}
...
# x
  CH:HERO:{
    ...
    2::DirTo:{"isWait":true,"rotType":0,"speedDeg":200.0,"speedDegSymbol":"","withWalkMotion":true,"targetRot":{"rotType":300,"onlyYaw":true,"rotQ":{"x":0.0,"y":0.8967284560203552,"z":0.0,"w":0.4425811767578125},"lookSymbol":"PARTNER"}}
  }
  CH:PARTNER:{
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D10P01_M01E08A_4_01_0010","★NONE★",[[ -- Hmmm...[K][R]Well, that didn't go well.
      うーん……[K]
      うまく　いかなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D10P01_M01E08A_4_01_0020","★NONE★",[[ -- Hmmm...[K][R]We didn't do well at all...
      うーん……[K]
      うまく　いかなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D10P01_M01E08A_4_01_0030","★NONE★",[[ -- That [kind_p:FURIIZAA]...[R]He's one tough customer.
      あの　[act_name:FURIIZAA]ってヤツ
      なかなか{強|つよ}いな。]]),
    TextID("D10P01_M01E08A_4_01_0040","★NONE★",[[ -- But why aren't we allowed[R]to go into this forest?
      しかし　なんでこの{森|もり}に
      {入|はい}っちゃいけないんだろう？]]),
    TextID("D10P01_M01E08A_4_01_0050","★NONE★",[[ -- It doesn't matter anyway.[R]Let's give it our best, [hero]!
      ……まあ　いいや。
      がんばっていこうぜ。[hero]！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D10P01_M01E08A_4_01_0060","★NONE★",[[ -- That Pokémon,[R][kind_p:FURIIZAA], is pretty tough.
      あの　[act_name:FURIIZAA]ってポケモン
      なかなか{強|つよ}いね。]]),
    TextID("D10P01_M01E08A_4_01_0070","★NONE★",[[ -- But why are we forbidden[R]from entering this forest?
      でも　なんでこの{森|もり}に
      {入|はい}っちゃいけないんだろう？]]),
    TextID("D10P01_M01E08A_4_01_0080","★NONE★",[[ -- It makes no difference.[R][hero], let's try our best!
      ……まあ　いいや。
      [hero]！　がんばっていこうね！]]),
  },
  -- -----------------------------------------
