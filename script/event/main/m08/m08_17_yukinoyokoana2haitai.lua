...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D11P01_DEAD_01_0010","★NONE★",[[ -- Urrrgh...[K][R]We couldn't get through...
      ううっ……[K]
      うまく　いかなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D11P01_DEAD_01_0020","★NONE★",[[ -- Ouch...[K][R]We couldn't break through...
      ううっ……[K]
      うまく　いかなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D11P01_DEAD_01_0030","★NONE★",[[ -- This is one harsh place, but let's be strong[R]and get through, [hero]!
      きびしいところだけど　がんばっていこうぜ！
      [hero]！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D11P01_DEAD_01_0040","★NONE★",[[ -- This is a harsh place, so let's do our best[R]to get through, [hero]!
      きびしいところだけど　がんばっていこうね！
      [hero]！]]),
  },
  -- -----------------------------------------
})
