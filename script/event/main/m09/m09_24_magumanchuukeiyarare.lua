...
-- <<★ActAssetBlob
ASSET:ActAsset_Map:d12_02_magma_md:{"symbolName":"d12_02_magma_md"}
...
Parallel:{
  ...
  *::{
    0::PlayBgm:{"symbol":"BGM_DUN_CHITEI_02","fadeInTime":0.0,"isLoop":true,"channel":0,"volume":1.0,"volumeSymbol":"DEFAULT"}
  }
}
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D12P02_M01E09A_14_01_0010","★NONE★",[[ -- Hmmm...[K][R]Well, that didn't go well.
      うーん……[K]
      うまく　いかなかったな……。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D12P02_M01E09A_14_01_0020","★NONE★",[[ -- Hmmm...[K][R]That didn't work out.
      うーん……[K]
      うまく　いかなかったね……。]]),
  },
  -- -----------------------------------------
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("D12P02_M01E09A_14_01_0030","★NONE★",[[ -- But we didn't have far to go![K][R]Let's give it our best!
      でも　あと　もう{少|すこ}しだ。[K]
      がんばろうな！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("D12P02_M01E09A_14_01_0040","★NONE★",[[ -- But we were very close![K][R]Let's keep trying our best!
      でも　あと　もうちょっとだよ。[K]
      がんばろうね！]]),
  },
  -- -----------------------------------------
