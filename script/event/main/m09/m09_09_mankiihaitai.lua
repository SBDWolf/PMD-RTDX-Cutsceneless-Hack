...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_S00E01A_1_01_0010","★NONE★",[[ -- Morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_S00E01A_1_01_0020","★CHANGE★",[[ -- We couldn't get it done for [kind_p:SOONANO][R]yesterday, so let's get it right this time.
      [act_name:SOONANO]の{依頼|いらい}だけど
      {今日|きょう}こそは　がんばろうな。]]),
    TextID("PEGID_M09_09_MANKIIHAITAI__8925","★NEW★",[[ -- Let's head to [dungeon:D016] and show[R]those [kind_p:MANKII] what's what!
      [dun:D016]へ{行|い}って　[act_name:MANKII]たちが
      {暴|あば}れるのをやめさせようぜ。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_S00E01A_1_01_0030","★NONE★",[[ -- Good morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_S00E01A_1_01_0040","★CHANGE★",[[ -- We let [kind_p:SOONANO] down yesterday,[R]so let's try harder this time.
      [act_name:SOONANO]の{依頼|いらい}だけど
      {今日|きょう}こそは　がんばろうね。]]),
    TextID("PEGID_M09_09_MANKIIHAITAI__7648","★NEW★",[[ -- Let's head to [dungeon:D016] and show[R]those [kind_p:MANKII] what's what!
      [dun:D016]へ{行|い}って　[act_name:MANKII]たちが
      {暴|あば}れるのをやめさせよう。]]),
  },
  -- -----------------------------------------
