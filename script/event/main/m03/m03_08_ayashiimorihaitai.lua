...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E03A_9_01_0010","★NONE★",[[ -- Morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_M01E03A_9_01_0020","★CHANGE★",[[ -- We've got to rescue [kind_p:TORANSERU] today.[R]Let's head out to [dungeon:D004]!
      {今日|きょう}こそは　[act_name:TORANSERU]を{助|たす}けような。
      {行|い}こうぜ　[dun:D004]へ。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E03A_9_01_0030","★NONE★",[[ -- Good morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_M01E03A_9_01_0040","★CHANGE★",[[ -- Let's be sure to save [kind_p:TORANSERU] today.[R]Let's head out to [dungeon:D004]!
      {今日|きょう}こそは　[act_name:TORANSERU]を{助|たす}けようね。
      {行|い}こう　[dun:D004]へ。]]),
  },
  -- -----------------------------------------
})
