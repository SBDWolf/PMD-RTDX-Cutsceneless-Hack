...
LuaWINDOW.Talk(LuaSymAct("PARTNER"),TextID("B01P01A_M01E02A_4_01_0010","★NONE★",[[ -- Morning, [hero].
  おはよう　[hero]。]]) )
LuaWINDOW.Talk(LuaSymAct("PARTNER"),TextID("PEGID_M02_05_DENJIHANODOUKUTSUHAITAI__2802","★NEW★",[[ -- We gotta quickly head to[R][dungeon:D002] and rescue [kind_p:KOIRU]!
  [dun:D002]へ{行|い}って
  {早|はや}く　[act_name:KOIRU]を{救助|きゅうじょ}しなくちゃ。]]))
LuaWINDOW.DrawFace(FACE_POS.LEFT_X, FACE_POS.LEFT_Y, LuaSymAct("PARTNER"), FACE_TYPE.HAPPY)
-- x
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E02A_4_01_0040","★NONE★",[[ -- Let's get it done right today!
      {今日|きょう}こそ　がんばろうぜ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E02A_4_01_0050","★NONE★",[[ -- Let's try to get it right today!
      {今日|きょう}こそは　がんばろうね！]]),
  },
  -- -----------------------------------------
})
