...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E02B_6_01_0010","★NONE★",[[ -- Morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_M01E02B_6_01_0020","★CHANGE★",[[ -- We blew it yesterday. Let's go to [dungeon:D003][R]and save [kind_p:DIGUDA] today for sure.
      {今日|きょう}こそは　[dun:D003]に{行|い}って
      [act_name:DIGUDA]を{助|たす}けような。]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E02B_6_01_0030","★NONE★",[[ -- Good morning, [hero].
      おはよう　[hero]。]]),
    TextID("B01P01A_M01E02B_6_01_0040","★CHANGE★",[[ -- We couldn't do it yesterday, so let's go to[R][dungeon:D003] and rescue [kind_p:DIGUDA] today.
      {今日|きょう}こそは　[dun:D003]に{行|い}って
      [act_name:DIGUDA]を{助|たす}けようね。]]),
  },
  -- -----------------------------------------
})
-- x
