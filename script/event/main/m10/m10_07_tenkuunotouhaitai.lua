...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E10A_5_01_0010","★NONE★",[[ -- Morning!
      おはよう！]]),
  },
  -- -----------------------------------------
  TYPE3={
    TextID("B01P01A_M01E10A_5_01_0060","★NONE★",[[ -- Good morning!
      おはよう！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E10A_5_01_0110","★NONE★",[[ -- Good morning!
      おはよう！]]),
  },
  -- -----------------------------------------
})
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E10A_5_01_0020","★NONE★",[[ -- Even while we do this, that falling star is[R]coming closer and closer...
      こうしている{間|あいだ}にも{星|ほし}は
      どんどん{接近|せっきん}している……。]]),
    TextID("B01P01A_M01E10A_5_01_0030","★CHANGE★",[[ -- The [dungeon:D013] is one harsh place.
      [dun:D013]は　きびしいところだと{思|おも}うけど……]]),
  },
  -- -----------------------------------------
  TYPE3={
    TextID("B01P01A_M01E10A_5_01_0070","★NONE★",[[ -- Even now, that falling star is getting[R]closer and closer...
      こうしている{間|あいだ}にも{星|ほし}は
      どんどん{接近|せっきん}している……。]]),
    TextID("B01P01A_M01E10A_5_01_0080","★CHANGE★",[[ -- The [dungeon:D013] is incredibly harsh, too.
      [dun:D013]は　きびしいところだと{思|おも}うけど……]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E10A_5_01_0120","★NONE★",[[ -- That falling star is coming closer and[R]closer even now...
      こうしている{間|あいだ}にも{星|ほし}は
      どんどん{接近|せっきん}している……。]]),
    TextID("B01P01A_M01E10A_5_01_0130","★CHANGE★",[[ -- The [dungeon:D013] is also very challenging.
      [dun:D013]は　きびしいところだと{思|おも}うけど……]]),
  },
  -- -----------------------------------------
})
...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E10A_5_01_0040","★NONE★",[[ -- But I'm not giving up!
      でもオイラ　あきらめないよ！]]),
    TextID("B01P01A_M01E10A_5_01_0050","★NONE★",[[ -- Let's give it our best, [hero]!
      がんばろうな！　[hero]！]]),
  },
  -- -----------------------------------------
  TYPE3={
    TextID("B01P01A_M01E10A_5_01_0090","★NONE★",[[ -- But I'm not giving up!
      でもワタシ　あきらめないよ！]]),
    TextID("B01P01A_M01E10A_5_01_0100","★NONE★",[[ -- Let's keep doing our best, [hero]!
      がんばろうね！　[hero]！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E10A_5_01_0140","★NONE★",[[ -- But I'm not giving up!
      でもボク　あきらめないよ！]]),
    TextID("B01P01A_M01E10A_5_01_0150","★NONE★",[[ -- Let's keep doing our best, [hero]!
      がんばろうね！　[hero]！]]),
  },
  -- -----------------------------------------
})
