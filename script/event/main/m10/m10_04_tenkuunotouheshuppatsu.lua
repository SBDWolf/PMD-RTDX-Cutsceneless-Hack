...
LuaWINDOW.SwitchTalk({
  TYPE1={
    TextID("B01P01A_M01E10A_3_01_0010","★NONE★",[[ -- Morning! Get a good night's sleep?
      おはよう！　よく　ねむれたかい？]]),
    TextID("B01P01A_M01E10A_3_01_0020","★NONE★",[[ -- This is it![K] Let's roll, [hero]![R]To the sky we go!
      さあ　いよいよだ！[K]
      {行|い}こうぜ！　[hero]！　{天空|てんくう}へ！]]),
  },
  -- -----------------------------------------
  DEFAULT={
    TextID("B01P01A_M01E10A_3_01_0030","★NONE★",[[ -- Good morning! Did you sleep well?
      おはよう！　よく　ねむれた？]]),
    TextID("B01P01A_M01E10A_3_01_0040","★NONE★",[[ -- This is it![K] Let's go, [hero]![R]We're off to the sky!
      さあ　いよいよだね！[K]
      {行|い}こう！　[hero]！　{天空|てんくう}へ！]]),
  },
  -- -----------------------------------------
})
-- x
